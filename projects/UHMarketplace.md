...
layout: project
type: project
image: image/Adobe Express - file.png
...
**GitHub Org:** [github.com/uh-marketplace](https://github.com/uh-marketplace)
...
- Set up PostgreSQL and Prisma ORM for the backend
- Wrote E2E tests with Playwright and configured CI/CD on GitHub Actions
- Refined the UI for a clean, mobile-responsive design
- Handled bug fixes, UI tweaks, and improved accessibility
...
- Build a secure, responsive web app with a modern stack
- Troubleshoot deployment (Vercel), databases, and edge-case bugs
- Collect and apply user feedback to improve UX
...
- [Organization GitHub](https://github.com/uh-marketplace)
- [Deployed App](https://uh-marketplace-app.vercel.app/)
